			...
			<li>
				...
				<div class="abio-l7__body">
					...
					<?php if ( $d['stats'] && ( $a['posts'] || '' !== $a['since'] ) ) : ?>
						<div class="abio-l7__stats">
							<?php if ( $a['posts'] ) : ?>
								<div class="abio-l7__stat">
									<span class="abio-l7__stat-value"><?php echo esc_html( number_format_i18n( $a['posts'] ) ); ?></span>
									<span class="abio-l7__stat-label"><?php echo esc_html( _n( 'article', 'articles', $a['posts'], 'author-bio' ) ); ?></span>
								</div>
							<?php endif; ?>
							<?php if ( '' !== $a['since'] ) : ?>
								<div class="abio-l7__stat">
									<span class="abio-l7__stat-value"><?php echo esc_html( $a['since'] ); ?></span>
									<span class="abio-l7__stat-label"><?php esc_html_e( 'writing since', 'author-bio' ); ?></span>
								</div>
							<?php endif; ?>
						</div>
					<?php endif; ?>
